...
class ProviderGetHired extends StatefulWidget {
  const ProviderGetHired({Key? key}) : super(key: key);

  @override
  State<ProviderGetHired> createState() => _ProviderGetHiredState();
}

class _ProviderGetHiredState extends State<ProviderGetHired> {
